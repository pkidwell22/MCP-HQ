...
final class ClaudeConfigParserTests: XCTestCase {
    func testParseClaudeConfigDiscoversStdioServers() throws {
        ...
        XCTAssertEqual(servers[0].id, ServerDefinition.canonicalID(agent: .claude, sourcePath: fixtureURL.path, name: "github"))
        ...
        XCTAssertEqual(servers[1].id, ServerDefinition.canonicalID(agent: .claude, sourcePath: fixtureURL.path, name: "qmd"))
